...
namespace VAdodaraHelpsE_DirectiveSystem.Pages
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        public static AjaxControlToolkit.Slide[] slidingAjex()
        {
            ...
            slides[0] = new AjaxControlToolkit.Slide("/img/project/6.jpg", "ered", "nice images");
            slides[1] = new AjaxControlToolkit.Slide("/img/project/7.jpg", "dss", "nice images");
            slides[2] = new AjaxControlToolkit.Slide("/img/project/8.jpg", "ds", "nice images");
            slides[3] = new AjaxControlToolkit.Slide("/img/project/9.jpg", "ds", "nice images");
